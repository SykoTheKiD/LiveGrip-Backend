...
urlpatterns = [
	...
	url(r'^messages&event=(?P<event_id>[0-9]+)', api.views.get_last_messages, name='get_messages'),
	url(r'^message_history&event=(?P<event_id>[0-9]+)&offset=(?P<offset>[0-9]+)', api.views.get_messagage_history, name='get_message_history'),
